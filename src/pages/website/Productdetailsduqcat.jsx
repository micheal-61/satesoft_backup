        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-stretch gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-3/5 text-left flex flex-col justify-center">
            ...
            <h5 className="uppercase text-primary-500 tracking-widest font-bold mb-8">
              Retail Intelligence for the African Market
            </h5>

            {/* Description */}
            <p className="text-xl text-text/70 leading-relaxed max-w-2xl mb-12">
              A comprehensive retail data analytics platform designed
              to capture and analyze consumer behavior in both formal
              and informal African markets. Duqact transforms raw
              transaction data into actionable insights for business
              growth.
            </p>
          </div>
...
export default ProductDetailsDuqcat;