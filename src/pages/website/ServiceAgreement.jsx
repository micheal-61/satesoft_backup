      ...
      <div className="container mx-auto px-8 sm:px-12 lg:px-20 py-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-text mb-4">Service Agreement</h1>
            <p className="text-lg text-text/70">Terms and conditions for using our services</p>
          </div>
                ...
                <div key={agreement.id} className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                  <div className="p-6 md:p-8">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h2 className="text-xl font-bold text-text">{agreement.title}</h2>
                    </div>
                    <div 
